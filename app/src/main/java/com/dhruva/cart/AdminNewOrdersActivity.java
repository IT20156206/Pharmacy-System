...
import com.dhruva.cart.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ordersRef = FirebaseDatabase.getInstance("https://madnewproject-6ccb8-default-rtdb.firebaseio.com/").getReference().child("Orders");
