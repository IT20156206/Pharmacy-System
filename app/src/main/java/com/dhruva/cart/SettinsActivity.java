...
public class SettinsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageProfilePrictureRef = FirebaseStorage.getInstance("gs://madnewproject-6ccb8.appspot.com").getReference().child("Profile pictures");
    ...
    private void updateOnlyUserInfo() {
        DatabaseReference ref = FirebaseDatabase.getInstance("https://madnewproject-6ccb8-default-rtdb.firebaseio.com/").getReference().child("Users");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance("https://madnewproject-6ccb8-default-rtdb.firebaseio.com/").getReference().child("Users").child(Prevalent.currentOnlineUser.getPhone());
